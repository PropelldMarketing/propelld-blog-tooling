...
def mark_duplicate_kills(df, t0_pages, t0_allowance=2):
    ...
    # Policy decision (31-Jul, marketing): links to DISTINCT money pages are
    # welcome in any count — they are quality commercial links when placed
    # naturally. Only same-target repeats are capped (2 for T0, 1 otherwise,
    # enforced above). The earlier t0-cta-overflow rule was removed here.
    return df, dup_mask
